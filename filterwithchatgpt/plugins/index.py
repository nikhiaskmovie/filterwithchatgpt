...
async def index_files(bot, message):
    """Save channel or group text and links"""
    if lock.locked():
      await message.reply('Wait until previous process complete.')
       ...
       while True:
        ...
        async with lock:
            ...
            await msg.edit(f'Total {total_files} messages containing the particular link saved to database!')
